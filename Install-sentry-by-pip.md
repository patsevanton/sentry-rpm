...
reboot
sudo pip install --trusted-host pypi.org --trusted-host files.pythonhosted.org requests==2.20.1 -U --ignore-installed
...
sudo pip install --trusted-host pypi.org --trusted-host files.pythonhosted.org PyYAML==3.11 -U --ignore-installed
